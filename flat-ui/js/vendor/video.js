...
(function() {
    ...
    t.d = function(a, c, d) {
        ...
        e.Y || (e.disabled = l, e.Y = function(c) {
            if (!e.disabled) {
                ...
                var d = e.D[c.type];
                if (d)
                    for (var d = d.slice(0), j = 0, n = d.length; j < n && !c.xc(); j++) d[j].call(a, c)
            }
        });
            ...
            if (e.D) {
                ...
                if (c) {
                    ...
                    if (g) {
                        if (d) {
                            if (d.z)
                                for (e = 0; e < g.length; e++) g[e].z === d.z && g.splice(e--, 1)
                        } else e.D[c] = [];
                        t.kc(a, c)
                    }
                } else
                    for (g in e.D) c = g, e.D[c] = [], t.kc(a, c)
            }
        }
    };
    t.kc = function(a, c) {
    ...
    var ba = t,
        z;
    var A = t.M.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i),
        B, C;
    ...
    s.vc = function() {
        ...
        if (c = this.options().children)
            if (t.h.isArray(c))
                for (var g = 0; g < c.length; g++) d = c[g], "string" == typeof d ? (e = d, d = {}) : e = d.name, a[e] = a.R(e, d);
            else t.h.Z(c, function(c, d) {
                d !== l && (a[c] = a.R(c, d))
            })
    };
    s.T = r("");
    ...
    s.ea = function(a) {
        if (37 == a.which || 40 == a.which) a.preventDefault(), this.Lc();
        else if (38 == a.which || 39 == a.which) a.preventDefault(), this.Mc()
    };
    s.Ya = function() {
        t.p(document, "keyup", t.bind(this, this.ea))
    };
    ...
    s.exitFullscreen = function() {
        ...
        else this.k.Ea() ? S(this, "exitFullScreen") : (this.Db(), this.m("fullscreenchange"));
        return this
    };
    s.pc = function() {
        this.Cd = f;
    ...
    s.src = function(a) {
        ...
        t.h.isArray(a) ? T(this, a) : "string" === typeof a ? this.src({
            src: a
        }) : a instanceof Object && (a.type && !window.videojs[this.fb].canPlaySource(a) ? T(this, [a]) : (this.G.src = a.src, this.nc = a.type || "", this.J(function() {
            S(this, "src", a.src);
    ...
    s.xa = function() {
        var a = new t.ia(this.j()),
            c = this.j().options().playbackRates;
        if (c)
            for (var d = c.length - 1; 0 <= d; d--) a.R(new t.ob(this.j(), {
                rate: c[d] + "x"
            }));
        return a
    };
    ...
    t.f = t.u.extend({
        i: function(a, c, d) {
            ...
            e && (e.type && t.f.Ed(e.type) ? (e = t.f.Nc(e.src), j.rtmpConnection = encodeURIComponent(e.xb), j.rtmpStream = encodeURIComponent(e.Rb)) : j.src = encodeURIComponent(t.sc(e.src)));
            t.Hb(g, d);
    ...
    s.update = function() {
        if (0 < this.ca.length) {
            ...
            if (this.Pb === b || a < this.Pb || this.Xa <= a) {
                ...
                for (;;) {
                    q = c[w];
                    if (q.ya <= a) e = Math.max(e, q.ya), q.Oa && (q.Oa = l);
                    else if (a < q.startTime) {
                        if (d = Math.min(d, q.startTime), q.Oa && (q.Oa = l), !g) break
                    } else g ? (h.splice(0, 0, q), n === b && (n = w), j = w) : (h.push(q), j === b && (j = w), n = w), d = Math.min(d, q.ya), e = Math.max(e, q.startTime), q.Oa = f;
                    if (g)
                        if (0 === w) break;
                        else w--;
    ...
    s.xa = function() {
        for (var a = this.c.textTracks(), c = 0, d = a.length, e, g, h = this.O = []; c < d; c++)
            if (e = a[c], e.K() == this.H)
                if (0 === e.readyState()) e.load(), e.d("loaded", t.bind(this, this.xa));
                else {
                    g = e;
                    break
                } a = this.Ba;
        ...
        t.JSON.parse = function(a, c) {
            function d(a, e) {
                ...
                if (q && "object" === typeof q)
                    for (j in q) Object.prototype.hasOwnProperty.call(q, j) && (n = d(q, j), n !== b ? q[j] = n : delete q[j]);
                return c.call(a, e, q)
            }
            var e;
            a = String(a);
    ...
    t.jc = function() {
        ...
        if (d && 0 < d.length)
            for (var e = 0, g = d.length; e < g; e++)
                if ((c = d[e]) && c.getAttribute) c.player === b && (a = c.getAttribute("data-setup"), a !== k && (a = t.JSON.parse(a || "{}"), videojs(c, a)));
                else {
                    t.vb();
                    break
                }
