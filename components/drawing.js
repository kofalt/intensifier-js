...
export default class Drawing extends React.Component {
    ...
    render() {
        return ( < div className = "row" > < div className = {
                "text-center " + (this.state.imageUploaded ? "col-sm-6" : "col-sm-6 col-sm-offset-3")
            } > < canvas ref = "canvas" / > < FileInput updatePicture = {
                this.updatePictureURL.bind(this)
            }
            /> < /div> < div className = {
                this.state.imageUploaded ? "col-sm-6" : "hidden"
            } > < form className = "form-horizontal" > < TextInput textChange = {
                this.textInputChange.bind(this)
            }
            /> < RangeInput rangeChange = {
                this.rangeText.bind(this)
            }
            labelText = "Text size"
            min = {
                this.minRange
            ...
            /> < ColorInput textColorChange = {
                this.textColorChange.bind(this)
            }
            textColor = {
                this.textColor.color
            }
            strokeColorChange = {
                this.strokeColorChange.bind(this)
            }
            strokeColor = {
                this.strokeColor.color
            }
            /> < RangeInput rangeChange = {
                this.rangeVibration.bind(this)
            }
            labelText = "Magnitude"
            min = {
                this.minRange
            ...
            /> < Download downloadGIF = {
                this.downloadGIF.bind(this)
            }
            /> < a ref = "download"
            href = "#"
            download = ""
            className = "hidden" > Download < /a> < /form> < /div> < /div>);
    }
};
